import type { AnimationType, Complexity, ComponentCategory } from './component-meta'
...
const VALID_COMPLEXITIES: readonly Complexity[] = ['simple', 'moderate', 'complex']

const VALID_ANIMATION_TYPES: readonly AnimationType[] = ['spring', 'tween', 'gesture', 'scroll', 'none']
