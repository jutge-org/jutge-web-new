    ...
    'relative inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap font-medium outline-none ring-offset-background transition-[transform,background-color,border-color,color,box-shadow] duration-150 ease-out focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 active:scale-[0.97] disabled:pointer-events-none disabled:opacity-50 motion-reduce:transition-none motion-reduce:active:scale-100 [&_svg]:pointer-events-none [&_svg]:shrink-0',
    {
        variants: {
            variant: {
                ...
                solid: 'bg-[var(--btn,var(--color-foreground))] text-[var(--btn-fg,var(--color-background))] shadow-xs hover:bg-[var(--btn-hover,var(--color-smooth-900))]',
            ...
            color: {
                accent: '[--btn-fg:#fff] [--btn-hover:var(--color-brand-secondary)] [--btn:var(--color-brand)]',
                neutral:
                ...
                amber: '[--btn-fg:var(--color-amber-fg)] [--btn-hover:var(--color-amber-hover)] [--btn:var(--color-amber)]',
                green: '[--btn-fg:var(--color-green-fg)] [--btn-hover:var(--color-green-hover)] [--btn:var(--color-green)]',
            },
            size: {
...
export type SmoothButtonProps = Omit<ButtonHTMLAttributes<HTMLButtonElement>, 'prefix' | 'color'> &
...
function SmoothButton({
    ...
    const classes = cn(smoothButtonVariants({ variant, color, size, shape, className }))
            ...
            <AnimatePresence initial={false}>
                {loading && (
                    <motion.span
                        ...
                        key="spinner"
                        transition={
                            shouldReduceMotion ? { duration: 0 } : { type: 'spring', duration: 0.25, bounce: 0.1 }
                        }
                    >
                        <Spinner />
                    </motion.span>
