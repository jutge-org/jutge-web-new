 ...
 * ambient animation.
 */
export const useAudioAmplitude = (options: UseAudioAmplitudeOptions = {}): UseAudioAmplitudeResult => {
    const { autoStart = false, smoothing = DEFAULT_SMOOTHING, fftSize = DEFAULT_FFT_SIZE } = options
