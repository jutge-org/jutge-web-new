...
const features = [
    {
        ...
        description: 'Real-time analytics dashboard with customizable metrics and beautiful visualizations.',
                        ...
                        {features.map((feature, index) => (
                            <motion.div
                                className={cn(
                                    ...
                                    feature.accent ? 'bg-primary/5 ring-1 ring-primary/10' : 'bg-background',
                                    feature.span,
                                )}
