                ...
                <div className="min-h-[120px] w-full">
                    <AnimatePresence mode="wait">
                        <motion.blockquote
                            ...
                            key={index}
                            transition={
                                shouldReduceMotion ? { duration: 0 } : { type: 'spring' as const, duration: 0.5 }
                            }
                        >
                ...
                <div className="flex w-full max-w-lg items-center justify-center gap-8 pt-8">
                    <AnimatePresence initial={false} mode="wait">
                        <motion.div
                            ...
                            initial={shouldReduceMotion ? { opacity: 1 } : { opacity: 0, filter: 'blur(8px)' }}
                            key={index}
                            transition={
                                shouldReduceMotion ? { duration: 0 } : { type: 'spring' as const, duration: 0.5 }
                            }
                        >
                            ...
                            <div className="text-left">
                                ...
                                <div className="text-base text-muted-foreground">{testimonials[index].role}</div>
                            </div>
                        </motion.div>
                    </AnimatePresence>
                </div>
                                ...
                                animate={
                                    shouldReduceMotion
                                        ? {
                                              ...
                                              height: CIRCLE_SIZE,
                                              borderRadius: isActive ? BORDER_RADIUS_ACTIVE : BORDER_RADIUS_INACTIVE,
                                          }
                                        : {
                                              width: isActive ? BAR_WIDTH : CIRCLE_SIZE,
                                              height: CIRCLE_SIZE,
