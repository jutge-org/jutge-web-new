    ...
    return (
        <section className="py-20">
            <div className="mx-auto max-w-7xl px-6">
                ...
                >
                    <h2 className="mb-4 font-bold text-3xl text-foreground lg:text-4xl">{title}</h2>
                    <p className="mx-auto max-w-2xl text-foreground/70 text-lg">{description}</p>
                </motion.div>

                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4" ref={ref}>
                    {stats.map((stat, index) => (
                        ...
                        >
                            ...
                            >
                                {React.createElement(iconMap[stat.icon as keyof typeof iconMap] || DollarSign, {
                                    className: 'h-8 w-8',
                                })}
                            </motion.div>
                            ...
                            {/* Description */}
                            {stat.description && <p className="mb-3 text-foreground/70 text-xs">{stat.description}</p>}
                            ...
                            {stat.trend && (
                                <motion.div
                                    animate={(() => {
                                        ...
                                        return isInView ? { opacity: 1, x: 0 } : { opacity: 0, x: -10 }
                                    })()}
