...
import { Canpoy, Canva, Casetext, Clearbit, Descript, Duolingo, Faire, Strava } from '@/components/smoothui/shared'
    ...
    return (
        <section className="overflow-hidden py-20">
            <div className="mx-auto max-w-7xl px-6">
                ...
                >
                    <motion.div
                        animate={shouldReduceMotion ? { x: 0 } : { x: [0, -SCROLL_DISTANCE_FACTOR * logos.length] }}
                        ...
                        {logos.map((logo, index) => (
                            ...
                            >
                                <motion.div
                                    ...
                                    whileHover={shouldReduceMotion ? {} : { scale: HOVER_SCALE, rotate: HOVER_ROTATE }}
                                >
                                    <logo.logo />
                                </motion.div>
                            </motion.a>
