...
const features = [
    ...
    {
        title: 'Accessible',
        description: 'Built with ARIA attributes, keyboard navigation, and reduced motion support.',
        icon: (
            <svg
                aria-hidden="true"
                className="h-6 w-6"
    ...
    {
        title: 'Animated',
        description: 'Smooth spring animations powered by Motion with configurable easing.',
        icon: (
            <svg
                aria-hidden="true"
                className="h-6 w-6"
    ...
    {
        title: 'Open Source',
        description: 'Free and open source. Install via the shadcn registry with one command.',
        icon: (
            <svg
                aria-hidden="true"
                className="h-6 w-6"
                ...
                <div className="mx-auto max-w-6xl px-6">
                    <div className="mx-auto mb-16 max-w-2xl text-center">
                        ...
                        <p className="mt-4 text-foreground/70 text-lg">
                            Production-ready components with animations, accessibility, and TypeScript built in.
                        </p>
                    </div>
                    <ul className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {features.map((feature, index) => (
                            <motion.li
                                ...
                                key={feature.title}
                                transition={shouldReduceMotion ? { duration: 0 } : { ...SPRING, delay: index * 0.05 }}
